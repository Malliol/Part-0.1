...
Представим вот вы с друзьями захотели посидеть поиграть и запускаете атернос и вот она проблема сервер не запуститься 
Вы встали в очередь 

![image](https://user-images.githubusercontent.com/90931685/170819775-be515964-4099-47f7-b9b0-f6707516318a.png)

ближе к вечеру западные жильци, а то есть по большей части амереканцы только просыпаються и они тоже захотели поиграть в майнкрафт 
